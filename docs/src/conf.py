...
# = other ======================================================================
htmlhelp_basename = 'mappr'
latex_elements = {}
latex_documents = [
    (master_doc, 'mappr.tex', 'mappr Documentation',
     'Mateusz \'novo\' Klos', 'manual'),
]
man_pages = [
    (master_doc, 'mappr', 'mappr Documentation', [author], 1)
]
texinfo_documents = [
    (master_doc, 'mappr', 'mappr Documentation',
     author, 'mappr', 'One line description of project.',
     'Miscellaneous'),
]
